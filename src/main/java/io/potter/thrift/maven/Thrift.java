...
/**
 * <p>This class represents an invokable configuration of the {@code thrift}
 * compiler. The actual executable is invoked using the plexus
 * {@link Commandline}.</p>
 *
 * <p>This class currently only supports generating java source files.</p>
 *
...
final class Thrift {
    ...
    private Thrift(String executable, String generator, ImmutableSet<File> thriftPath,
        ...
        this.thriftPathElements = Preconditions.checkNotNull(thriftPath, "thriftPath");
        this.thriftFiles = Preconditions.checkNotNull(thriftFiles, "thriftFiles");
    ...
    static final class Builder {
        ...
        public Builder addThriftFile(File thriftFile) {
            Preconditions.checkNotNull(thriftFile);
            Preconditions.checkArgument(thriftFile.isFile());
            Preconditions.checkArgument(thriftFile.getName().endsWith(".thrift"));
        ...
        private void checkThriftFileIsInThriftPath(File thriftFile) {
            ...
            Preconditions.checkState(checkThriftFileIsInThriftPathHelper(thriftFile.getParentFile()));
        }
        ...
        private boolean checkThriftFileIsInThriftPathHelper(File directory) {
            ...
            if (thriftPathElements.contains(directory)) {
                ...
                return (parentDirectory != null) && checkThriftFileIsInThriftPathHelper(parentDirectory);
            }
        }
        ...
        public Builder addThriftPathElement(File thriftPathElement) {
            Preconditions.checkNotNull(thriftPathElement);
            Preconditions.checkArgument(thriftPathElement.isDirectory());
         ...
         */
        public Thrift build() {
            Preconditions.checkState(!thriftFiles.isEmpty());
